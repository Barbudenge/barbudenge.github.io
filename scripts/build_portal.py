...
def home(pt, articles):
    ...
    description = 'Aprenda mecanismos com exemplos resolvidos, trilhas de artigos e os simuladores Engrenarium, CrucibleCam e Powertrain Interativo.' if pt else 'Study mechanisms with worked examples, guided reading and the Engrenarium, CrucibleCam and Interactive Powertrain simulators.'
...
<section class="section reference-shelf"><div class="wrap"><h2>{'Material de consulta' if pt else 'Reference shelf'}</h2>{''.join(archived)}</div></section></main>'''
